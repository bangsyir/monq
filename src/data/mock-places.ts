import type { Place, PlaceComment, PlaceReview } from "@/types/place"
...
export const mockComments: Record<string, Array<PlaceComment>> = {
  "1": [
    {
      id: "c1",
      userId: "u1",
      ...
      userAvatar:
        "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100",
      comment:
        "Absolutely stunning waterfall! The hike was challenging but so worth it. Arrived early morning and had the place to ourselves. The mist creates magical rainbows in the sunlight! 🌈",
      ...
      replies: [
        {
          ...
          userAvatar:
            "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100",
          comment:
            "What time did you arrive? I'm planning to visit next weekend and want to avoid crowds!",
    ...
    },
    {
      ...
      userAvatar:
        "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100",
      comment:
        "The trail through the redwoods is magical. Bring waterproof gear as the mist from the falls can reach quite far. Perfect spot for photography enthusiasts. Canon R5 did justice to this beauty! 📸",
    ...
    },
    {
      ...
      comment:
        "Beautiful waterfall but it can get crowded on weekends. I recommend visiting on a weekday if possible. The parking lot fills up quickly - arrive before 8 AM!",
      ...
      replies: [
        {
          ...
          comment:
            "Thanks for the tip! Weekday it is then. How's the cell reception there?",
  ...
  "2": [
    {
      ...
      userAvatar:
        "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100",
      comment:
        "Best camping experience of my life! Watching the sunset over the Pacific from our tent was unforgettable. Book well in advance - spots fill up 3 months ahead! 🏕️🌅",
      createdAt: "2024-11-28T19:20:00Z",
      replies: [],
    },
    {
      id: "c5",
      ...
      comment:
        "The ocean views are breathtaking at dawn. Woke up to whales migrating! Bring warm layers though - it gets chilly at night even in summer. 🐋",
      ...
      replies: [
        {
          ...
          comment: "Wow, whales! That's incredible. What month was this?",
  ...
  "3": [
    {
      ...
      comment:
        "Challenging but incredibly rewarding hike! The final rock scramble section requires good upper body strength. 360-degree views from the summit are absolutely worth the effort. Bring at least 3L of water! 💪",
      ...
      replies: [
        {
          ...
          comment:
            "Thanks for the water tip! How technical is the rock scramble section for beginners?",
    ...
    },
    {
      ...
      userAvatar:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100",
      comment:
        "Saw a mountain goat at the summit! The wildflowers in July are spectacular. Start early - afternoon thunderstorms are common and dangerous above treeline. 🐐⛈️",
  ...
  "5": [
    {
      ...
      comment:
        "Crystal Lake lives up to its name! The water is so clear you can see trout swimming. Perfect spot for kayaking and photography. The reflection of the Tetons is like something out of a painting! 🏔️🛶",
      ...
      replies: [
        {
          ...
          comment:
            "Do they rent kayaks there or do you need to bring your own?",
        ...
        },
        {
          ...
          userAvatar:
            "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=100",
          comment:
            "They have rentals at the marina, about $25/hour. Worth every penny!",
          createdAt: "2024-08-10T17:45:00Z",
        },
      ],
    },
    {
      ...
      userAvatar:
        "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100",
      comment:
        "Camping here was magical! Woke up to moose drinking from the lake at sunrise. The stars are incredible - no light pollution. Bring bear spray and store food properly! 🐻✨",
  ...
  "8": [
    {
      ...
      comment:
        "Mirror Lake is absolutely stunning! The reflection of the mountain peaks in the perfectly still water is surreal. Best visited at sunrise for golden hour photos. 📸🏔️",
      createdAt: "2024-09-12T06:45:00Z",
      replies: [
        {
          id: "r7",
          userId: "u16",
          ...
          userAvatar:
            "https://images.unsplash.com/photo-1552374196-c4e7ffc6b126?w=100",
          comment:
            "How was the wildlife situation? Any bears or other animals to be aware of?",
          createdAt: "2024-09-12T12:30:00Z",
        },
      ],
    },
    {
      ...
      comment:
        "The hike is challenging but the views make it 100% worth it! Took us about 5.5 hours with breaks. Pack layers - temperature changes dramatically with elevation. 🌬️",
      ...
      replies: [
        {
          ...
          userAvatar:
            "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=100",
          comment:
            "Great tip! We definitely needed our jackets at the summit even though it was warm at the trailhead.",
